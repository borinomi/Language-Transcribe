...
def create_srt(subs, originals, translations, output_path):
    # SRT 파일 생성 (원본 + 번역)
...
def main():
    ...
    try:
        ...
        if translations:
            create_srt(subs, subs_texts, translations, output_path)
        else:
            create_srt(subs, subs_texts, [None]*len(subs_texts), output_path)
